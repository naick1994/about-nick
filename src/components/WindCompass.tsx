...
export function WindCompass({ directionDeg, speedKn, gustsKn, temperatureC }: {
  ...
  return (
    <div className="group relative rounded-xl border border-border bg-card/70 backdrop-blur px-5 py-4 flex items-center gap-4 overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-[var(--shadow-hover)]">
